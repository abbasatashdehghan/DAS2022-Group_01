...
Referring to \ref{tabel:summary}, it is noticeable that the data have different scales. The difference between mean and median of some variables also indicating the presence of large outliers in the data. The following pair plots fuhrer support the presence of outliers.
