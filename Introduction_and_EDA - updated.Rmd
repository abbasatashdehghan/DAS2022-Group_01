...
Referring to \ref{tabel:summary}, the difference between mean of some variables indicating the presence of large outliers in the data. The following pair plots fuhrer support the presence of outliers. 
...
Figure \ref{fig:outliers} presents the distribution of outcome variables with regards to each of the continuous variables. The boxplots can further help identify the outliers 
