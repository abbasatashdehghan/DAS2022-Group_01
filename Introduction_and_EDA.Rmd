...
## Recast variables
we add a new column called "Number_of_Family_new", reducing the level of "Number_of_Family" from 15 to 2 to be used for binomial model. The median value of `r median(data$Number_of_Family)` is used as the cut off point. Therefore they are divided into groups of families of less than or equal to 4 members and greater than 4 members.
